...
class CreditNoteParser
{
    ...
    public static function parse(EFacturaXml $xml): EFacturaData
    {
        return new EFacturaData(
            ...
            dueDate: null,
            type: InvoiceType::tryFrom($xml->get('CreditNoteTypeCode')) ?? InvoiceType::NotaDeCreditare,
            note: implode("\n", $xml->getValues('Note')),
            ...
            lines: array_map(fn($node) => InvoiceLineData::fromXml($node), $xml->nodes('CreditNoteLine')),
